# Mid Terms AFRs Table.CSV scraper

The following is a local scraper (Python) that pulls all years linked from `evans-legal.com` and extracts the Mid Term Rates.

> The year link list is on the 2026 page.   
...
python scrape_midterm_afrs.py
```

It will produce AFRs Table.CSV containing the Mid Term table for every year linked from the 2026 page.   